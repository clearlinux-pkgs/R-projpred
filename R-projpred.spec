...
Version  : 2.9.0
Release  : 37
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/projpred_2.9.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/projpred_2.9.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752160261
...
/usr/lib64/R/library/projpred/tests/testthat/helpers/creators.R
